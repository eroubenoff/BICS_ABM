...
int main(int argc, char **argv) {
    ...
    sample_params.SCHOOL_CONTACTS = true;
    ...
    std::copy(begin(fertility), end(fertility), begin(sample_params.FERTILITY_VEC));
    float mortality[9] = {0.000143, 0.000889, 0.001808, 0.002879, 0.00531, 0.011171, 0.0121513, 0.0151194, 0.157433};
    std::copy(begin(mortality), end(mortality), begin(sample_params.MORTALITY_VEC));
